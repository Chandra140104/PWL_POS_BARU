...
{
    // Ambil data user dengan kolom file_profil ditambahkan
    ...
    return DataTables::of($users)
        ...
        ->addColumn('file_profil', function ($user) {
            // Tampilkan gambar jika file_profil ada
            if ($user->file_profil) {
                // Gunakan asset untuk mengakses gambar dari folder storage
                return '<img src="'.asset('storage/'.$user->file_profil).'" alt="User Image" width="50"/>';
            } else {
                return '<img src="'.asset('storage/default.png').'" alt="Default Image" width="50"/>'; // default jika tidak ada foto
            }
        })
        ...
        ->rawColumns(['file_profil', 'aksi']) // pastikan file_profil bisa dirender sebagai HTML
        ->make(true);
}
